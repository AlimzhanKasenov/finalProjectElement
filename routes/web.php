...
Route::group(['prefix' => 'colors'], function (){
    Route::get('/', \App\Http\Controllers\Color\IndexController::class) -> name('colors.index');
...
Route::group(['prefix' => 'users'], function (){
    Route::get('/', \App\Http\Controllers\User\IndexController::class) -> name('users.index');
...
Route::group(['prefix' => 'products'], function (){
    ...
    Route::post('/create', \App\Http\Controllers\Product\StoreController::class) -> name('product.create');
